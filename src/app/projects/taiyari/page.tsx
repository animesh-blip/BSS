      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
            {[
              { number: 1800, label: "Direct Beneficiaries", icon: Users },
              { number: 20000, label: "Indirect Impact", icon: BarChart3 },
              ...
              <ScrollReveal key={s.label} delay={i * 0.1}>
                <div className="rounded-2xl bg-green-50 border border-green-100 p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">
                    <AnimatedCounter end={s.number} suffix={s.number >= 1000 ? "+" : ""} />
                  </div>
            ...
            <ScrollReveal direction="left" className="lg:col-span-2">
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <div className="rounded-2xl overflow-hidden mb-8">
                  <Image
                    src={images.programs.health}
                    alt="Taiyari health awareness programme"
                    width={800}
                    height={400}
