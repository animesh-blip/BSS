...
export const metadata: Metadata = {
  ...
  description: "Past programmes by Bal Sansar Sanstha including Sambal Community Care Center and Babli Boli that created lasting impact.",
};
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
          {completedProjects.map((project) => (
            <div key={project.title} className={`rounded-3xl border ${project.color} p-8 sm:p-10`}>
