...
export const metadata: Metadata = {
  ...
  description: "SEDI addresses skill-building needs of rural women and youth through computer training, photography, sewing courses, and RKCL certification in Ajmer, Rajasthan.",
};
