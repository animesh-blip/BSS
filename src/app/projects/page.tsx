          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-6">
            {completedProjects.map((project, i) => (
              <ScrollReveal key={project.title} delay={i * 0.15}>
                <Link
                  href={project.link}
                  className="group rounded-2xl bg-white border border-gray-100 p-8 card-hover block h-full"
                >
          ...
          <div className="mt-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <ScrollReveal key={area.label} delay={i * 0.08}>
                <div className="rounded-2xl bg-white border border-gray-100 p-5 text-center card-hover h-full">
