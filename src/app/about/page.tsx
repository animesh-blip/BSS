...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Bal Sansar Sanstha — a registered non-profit voluntary organization established in 1992 in Jaipur, Rajasthan, working for children, women, and vulnerable communities.",
};
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="rounded-3xl bg-gradient-to-br from-primary/5 via-muted to-secondary/5 p-10 border border-gray-100">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center p-4">
                    <div className="text-4xl font-bold text-primary">{siteConfig.founded}</div>
      ...
      <section className="py-20 sm:py-28 bg-muted relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="rounded-3xl bg-white border border-gray-100 p-10 card-hover">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {siteConfig.objectives.map((obj, i) => (
              <div key={obj} className="flex items-start gap-3 rounded-2xl bg-white border border-gray-100 p-5 card-hover">
      ...
      <section className="py-20 sm:py-28 bg-muted">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value) => (
              <div key={value.title} className="bg-white rounded-2xl p-7 text-center card-hover border border-gray-100">
          ...
          <div className="rounded-3xl bg-gradient-to-br from-foreground to-secondary-dark p-10 sm:p-14 text-white relative overflow-hidden">
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-3 gap-10 items-center">
              ...
              <div className="text-center">
                <div className="inline-flex h-40 w-40 items-center justify-center rounded-full bg-gradient-to-br from-primary/30 to-secondary/30 border-4 border-white/10 text-5xl">
                  👤
                </div>
